...
def create_contest(
    ...
    contest_class.create(
        alias=alias,
        title=title,
        description=description,
        start_time=unix_start_time,
        finish_time=unix_end_time,
        scoreboard=scoreboard,
        points_decay_factor=DEFAULT.POINTS_DECAY_FACTOR,
        submissions_gap=DEFAULT.SUBMISSION_GAP,
        penalty=DEFAULT.PENALTY,
        feedback=DEFAULT.FEEDBACK,
        penalty_type=DEFAULT.PENALTY_TYPE,
        languages=languages,
    )
